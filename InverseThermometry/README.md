...
This implementation was developed as part of the course project for *Technologies of Science-Informed Machine Learning*, lectured by Alexander Ryabov, Grigory Shutov, Nikolay Yavich, and Vladimir Vanovskiy at the Applied AI Institute, Skoltech. The key feature is to integrate classical numerical methods with modern automatic differentiation frameworks, enabling efficient and accurate computation of derivatives within established scientific algorithms.

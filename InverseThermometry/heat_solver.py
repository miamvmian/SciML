...
def harmonic_average(sigma, axis, eps=1e-8):
    """
...
def solve_heat_equation(sigma, source_func, M, T, n_steps=None, device='cpu'):
    ...
    Args:
        sigma: conductivity field [M, M] with requires_grad=True or sigmax: maximum conductivity
    ...
    # Compute time step and number of steps
    if n_steps is None:
